  ...
  useTranslation: () => ({
    t: (key: string) => {
      ...
      const translations: Record<string, string> = {
        ...
        'account.settings_title': 'Developer settings',
        'account.settings_description': 'Create a revocable personal access token for the Kolium API and future MCP integrations.',
        'account.settings_create_token': 'Create personal access token',
        'account.settings_token_name': 'Token name',
        'account.settings_token_name_placeholder': 'e.g. Kolium MCP',
        'account.settings_token_name_required': 'Enter a name for the token.',
        'account.settings_token_expiration': 'Expiration',
        'account.settings_token_expire_30': '30 days',
        'account.settings_token_expire_90': '90 days',
        'account.settings_token_expire_365': '1 year',
        'account.settings_token_never_expire': 'Never expires',
        'account.settings_generate_token': 'Generate token',
        'account.settings_token_once_title': 'Copy your new token now',
        'account.settings_token_once_description': 'For your security, Kolium will not show this token again after you leave this tab.',
        'account.settings_token_value': 'New personal access token',
        'account.settings_copy_token': 'Copy token',
        'account.settings_token_copied': 'Token copied to clipboard.',
        'account.settings_token_created': 'Token created successfully.',
        'account.settings_existing_tokens': 'Your personal access tokens',
        'account.settings_refresh_tokens': 'Refresh tokens',
        'account.settings_no_tokens': 'No personal access tokens yet.',
        'account.settings_active': 'Active',
        'account.settings_revoked': 'Revoked or expired',
        'account.settings_expires_on': 'expires',
        'account.settings_revoke': 'Revoke',
        'account.settings_load_error': 'Unable to load personal access tokens.',
        'account.settings_create_error': 'Unable to create personal access token.',
        'account.settings_revoke_error': 'Unable to revoke personal access token.',
